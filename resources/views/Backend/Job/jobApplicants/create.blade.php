								...
								<form class="row" action="{{route('jobApplicants.store')}}" method="post" encType ="multipart/form-data">
									...
									<div class="col-12 form-group">
											...
											<div class="col-md-6 form-group">
												...
												<select class=" form-control" name="job_post_id" >
													@foreach($job_ids  as $key => $job_id)
														<option value="{{$key}}"> {{$job_id}}  </option>
													@endforeach
												</select>
											</div>
											<div class="col-md-6 form-group">
												<label>Experience:</label>
												<select class="form-control required" name="experience" id="jobs-application-experience">
										...
										<div class="form-group">
											...
											<input type="text" name="website" id="jobs-application-phone" class="form-control required"
												   value="" placeholder="">
										</div>
