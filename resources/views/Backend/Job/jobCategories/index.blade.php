                                                ...
                                                @foreach($jobCategories as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{--</div>--}}
                                                            <div class="btn-group">
                                                                <a title="Edit" href='{{route('jobCategories.edit',$row->id)}}' class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>

                                                            </div>
                                                            <!-- todo: have problem in mobile device -->
                                                            <div class="btn-group">
                                                                <form  class="myAction" method="POST" action="{{route('jobCategories.destroy',$row->id)}}">
                                                                    @csrf
