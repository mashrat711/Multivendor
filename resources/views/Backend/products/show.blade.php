					...
					<div class="single-product">
						...
						<div class="product">
									...
									<div class="fslider" data-pagi="false" data-arrows="false" data-thumbs="true">
										<div class="flexslider">
											<div class="slider-wrap" data-lightbox="gallery">
												<div class="slide" data-thumb="{{asset("images/$product->image_path")}}"><a href="{{asset("images/$product->image_path")}}" title="Pink Printed Dress - Front View" data-lightbox="gallery-item"><img src="{{asset("images/$product->image_path")}}" alt="Pink Printed Dress"></a></div>
												<div class="slide" data-thumb="{{asset("images/$product->image_path")}}"><a href="{{asset("images/$product->image_path")}}" title="Pink Printed Dress - Side View" data-lightbox="gallery-item"><img src="{{asset("images/$product->image_path")}}" alt="Pink Printed Dress"></a></div>
												<div class="slide" data-thumb="{{asset("images/$product->image_path")}}"><a href="{{asset("images/$product->image_path")}}" title="Pink Printed Dress - Back View" data-lightbox="gallery-item"><img src="{{asset("images/$product->image_path")}}" alt="Pink Printed Dress"></a></div>
											</div>
										</div>
									</div>
							...
							<div class="col_one_fifth col_last">
								...
								<a href="#" title="Brand Logo" class="d-none d-md-block"><img class="image_fade" src="{{asset('assets/images/brian/brian.png')}}" alt="Brand Logo"></a>
