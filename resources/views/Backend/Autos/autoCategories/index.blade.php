                ...
                <div class="page-wrapper">
                    ...
                    <div class="page-header card">
                        <div class="card-block">
                            <h5 class="m-b-10">AutoCategories Model</h5>
                            <a href="{{route('autoCategories.create')}}">
                                                ...
                                                @foreach($autos as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{--</div>--}}
                                                            <div class="btn-group">
                                                                <a title="Edit" href='{{route('autoCategories.edit',$row->id)}}' class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>

                                                            </div>
                                                            <!-- todo: have problem in mobile device -->
                                                            <div class="btn-group">
                                                                <form  class="myAction" method="POST" action="{{route('autoCategories.destroy',$row->id)}}">
                                                                    @csrf
