                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="page-header card">
                                    <div class="card-block">
                                        <form action="{{url("autoCategories/$autoCategory->id")}}" method="post">
                                            @csrf
                                            @method('put')
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input id="userName-2b" name="title" type="text" class=" form-control"
                                                               value="{{ old("title") ? old("title") : (!empty($autoCategory) ? $autoCategory->title: null) }}">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for=""  class="block">Subtitle</label>

                                                        <input id="userName-2b" name="subtitle" type="text" class=" form-control"
                                                               value="{{ old("subtitle") ? old("subtitle") : (!empty($autoCategory) ? $autoCategory->subtitle: null) }}">
                                                    </div>
                                                </div>
                                            </div>
