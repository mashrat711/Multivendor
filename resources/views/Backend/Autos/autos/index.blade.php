                                                ...
                                                @foreach($autos as $row)
                                                    <tr>
                                                        ...
                                                        <td><img class="d-flex align-self-center img-radius" style="height: 70px;width: 83px"
                                                                 src='{{asset("images/$row->image")}}' alt=""></td>

                                                        <td>
                                                            <div class="btn-group">
                                                                <a title="Details"  href='{{route('autos.show',$row->id)}}'  class="btn btn-primary btn-sm"><i class="fa fa-eye"></i>
                                                                </a>
                                                            </div>
                                                            <div class="btn-group">
                                                            ...
                                                            <div class="btn-group">
                                                                <form  class="myAction" method="POST" action="{{route('autos.destroy',$row->id)}}">
                                                                    @csrf
