                                                ...
                                                @foreach($models as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{--</div>--}}
                                                            <div class="btn-group">
                                                                <a title="Edit" href='{{route('car_models.edit',$row->id)}}' class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>

                                                            </div>
                                                            <!-- todo: have problem in mobile device -->
                                                            <div class="btn-group">
                                                                <form  class="myAction" method="POST" action="{{route('car_models.destroy',$row->id)}}">
                                                                    @csrf
