...
@section('content')
		...
		<section id="slider" class="slider-element full-screen clearfix" style="background: url('{{asset('assets/demos/real-estate/images/hero/2.jpg')}}') top right no-repeat; background-size: cover;" data-height-md="550">
			...
			<div class="full-screen">
					...
					<div class="container clearfix">
						<div class="tabs advanced-real-estate-tabs nomargin clearfix" style="max-width: 500px;">
							...
							<ul class="tab-nav clearfix">
								<li class="noleftmargin"><a href="#tab-buy">Buy</a></li>
								<li class="noleftmargin"><a href="#tab-rent">Rent</a></li>
							</ul>
							...
							<div class="tab-container">
									...
									<form action="#" method="post" class="nobottommargin">
										<div class="row">
											...
											<div class="col-md-12 clearfix">
												<button class="button button-3d button-rounded btn-block nomargin" style="margin-top: 35px !important;">Search Properties</button>
											</div>
										</div>
									</form>
								</div>
								...
								<div class="tab-content clearfix" id="tab-rent">
									<form action="#" method="post" class="nobottommargin">
										<div class="row">
											<div class="col-md-6 col-12 bottommargin-sm">
												<label for="">Rental Locations</label>
												<select class="selectpicker form-control" multiple data-live-search="true" data-size="6" style="width:100%;">
													<optgroup label="Alaskan/Hawaiian Time Zone">
														<option value="AK">Alaska</option>
														<option value="HI">Hawaii</option>
											...
											<div class="col-md-12 clearfix">
												<button class="button button-3d button-rounded btn-block nomargin" style="margin-top: 35px !important;">Search Rentals</button>
											</div>
										</div>
									</form>
								</div>
				...
				<div class="video-wrap">
					...
					<div class="video-overlay" style="background-color: rgba(0,0,0,0.3); z-index: 1;"></div>
				</div>
			</div>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
							...
							<div class="oc-item">
								<div class="real-estate-item">
									<div class="real-estate-item-image">
										...
										<a href="#">
											<img src="{{asset('assets/demos/real-estate/images/items/4.jpg')}}" alt="Image 3">
										</a>
										<div class="real-estate-item-price">
					...
					<div class="row real-estate-properties clearfix">
						...
						<div class="col-lg-7">
							<a href="#" style="background: url('{{asset('assets/demos/real-estate/images/cities/4.jpg')}}') no-repeat bottom center; background-size: cover;">
						...
						<div class="col-lg-5">
							<a href="#" style="background: url('{{asset('assets/demos/real-estate/images/cities/2.jpg')}}') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('{{asset('assets/demos/real-estate/images/cities/3.jpg')}}') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('{{asset('assets/demos/real-estate/images/cities/1.jpg')}}') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('{{asset('assets/demos/real-estate/images/cities/5.jpg')}}') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block nomargin noborder">
					...
					<div class="col-lg-3" style="background-color: #E5E5E5;">
						<div style="padding: 40px;">
							...
							<div style="font-size: 15px; line-height: 1.7;">
								...
								<h4 class="font-body t500" style="font-size: 17px; margin-bottom: 10px;">Working Hours:</h4>{{asset('assets/')}}
				...
				<div class="container clear-bottommargin clearfix">
					...
					<div class="col_one_third col_last">
						...
						<ul class="clients-grid grid-2 nobottommargin clearfix">
							<li style="padding: 20px;"><a href="#" style="opacity: 0.9"><img src="{{asset('assets/demos/real-estate/images/builders/1.png')}}" alt="Clients"></a></li>
							<li style="padding: 20px;"><a href="#" style="opacity: 0.9"><img src="{{asset('assets/demos/real-estate/images/builders/2.png')}}" alt="Clients"></a></li>
							<li style="padding: 20px;"><a href="#" style="opacity: 0.9"><img src="{{asset('assets/demos/real-estate/images/builders/3.png')}}" alt="Clients"></a></li>
							<li style="padding: 20px;"><a href="#" style="opacity: 0.9"><img src="{{asset('assets/demos/real-estate/images/builders/4.png')}}" alt="Clients"></a></li>
						</ul>
