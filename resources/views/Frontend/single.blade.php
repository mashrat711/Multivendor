...
@section('content')
		...
		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element dark parallax clearfix" style="background-image: url('{{asset('assets/demos/real-estate/images/single-condo.jpg')}}'); background-size: cover; height: 550px;" data-bottom-top="background-position:0px 200px;" data-top-bottom="background-position:0px -200px;">
				...
				<div class="real-estate-info-wrap">
					<div class="heading-block nobottommargin nobottomborder d-md-flex d-block align-items-center justify-content-between">
						...
						<div class="d-flex flex-shrink-1" data-lightbox="gallery">
							<a href="{{asset('assets/demos/real-estate/images/hero/4.jpg')}}" class="button button-color button-rounded nott nomargin t500 align-self-end" data-lightbox="gallery-item"><i class="icon-picture"></i> View Gallery</a>
							<a href="{{asset('assets/demos/real-estate/images/hero/2.jpg')}}" class="hidden" data-lightbox="gallery-item"></a>
							<a href="{{asset('assets/demos/real-estate/images/hero/3.jpg')}}" class="hidden" data-lightbox="gallery-item"></a>
					...
					<div class="container clearfix">
						<div class="row">
							<div class="col-md-2 col-6 center">
								<img src="{{asset('assets/demos/real-estate/images/user.jpg')}}" alt="" class="img-circle" style="width: 60px; height: 60px;">
							...
							<ol class="commentlist nobottomborder clearfix">
									...
									<div id="comment-1" class="comment-wrap clearfix">
										...
										<div class="comment-meta">
											...
											<div class="comment-author vcard">
												...
												<img alt='' src='https://img1.jurko.net/avatar_15703.jpg' class='avatar avatar-60 photo avatar-default' height='60' width='60' /></span>
											...
											<div id="comment-3" class="comment-wrap clearfix">
												...
												<div class="comment-meta">
													...
													<div class="comment-author vcard">
														...
														<span class="comment-avatar clearfix">
														<img alt='' src='../../../public/assets/demos/real-estate/images/user.jpg' class='avatar avatar-40 photo' height='40' width='40' /></span>
								...
								<li class="comment byuser comment-author-_smcl_admin even thread-odd thread-alt depth-1" id="li-comment-2">
									<div id="comment-2" class="comment-wrap clearfix">
										...
										<div class="comment-content clearfix">
											<div class="comment-author"><a href='https://themeforest.net/user/semicolonweb' rel='external nofollow' class='url'>Hilary Ouse</a><span><a href="#" title="Permalink to this comment">June 21, 2016 at 1:03 am</a></span></div>
								...
								<li class="comment byuser comment-author-_smcl_admin even thread-odd thread-alt depth-1" id="li-comment-2">
									<div id="comment-3" class="comment-wrap clearfix">
										...
										<div class="comment-content clearfix">
											<div class="comment-author"><a href='https://themeforest.net/user/semicolonweb' rel='external nofollow' class='url'>AL3XL</a><span><a href="#" title="Permalink to this comment">April 25, 2015 at 1:03 am</a></span></div>
				...
				<div class="container clearfix">
					...
					<div class="real-estate-item col_one_third">
						<div class="real-estate-item-image">
							...
							<a href="#">
								<img src="{{asset('assets/demos/real-estate/images/items/1.jpg')}}" alt="Image 1">
							</a>
							<div class="real-estate-item-price">
								$1.2m<span>Leasehold</span>
							</div>
							<div class="real-estate-item-info clearfix" data-lightbox="gallery">
								<a href="{{asset('assets/demos/real-estate/images/items/1.jpg')}}" data-toggle="tooltip" title="Images" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
								<a href="{{asset('assets/demos/real-estate/images/items/3.jpg')}}" class="hidden" data-lightbox="gallery-item"></a>
					...
					<div class="real-estate-item col_one_third">
						<div class="real-estate-item-image">
							...
							<a href="#">
								<img src="{{asset('assets/demos/real-estate/images/items/2.jpg')}}" alt="Image 2">
							</a>
							<div class="real-estate-item-price">
					...
					<div class="real-estate-item col_one_third col_last">
						<div class="real-estate-item-image">
							...
							<a href="#">
								<img src="../../../public/assets/demos/real-estate/images/items/3.jpg" alt="Image 3">
							</a>
							<div class="real-estate-item-price">
								$1600<span>per Sale</span>
							</div>
							<div class="real-estate-item-info clearfix" data-lightbox="gallery">
								<a href="../../../public/assets/demos/real-estate/images/items/1.jpg" data-toggle="tooltip" title="Images" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
								<a href="../../../public/assets/demos/real-estate/images/items/3.jpg" class="hidden" data-lightbox="gallery-item"></a>
								<a href="#" data-toggle="tooltip" title="Like"><i class="icon-line-heart"></i></a>
							</div>
						</div>
