@extends('Frontend.Elements.master')
@section('content')
...
{{--<body class="stretched">--}}
	...
	{{--<div id="wrapper" class="clearfix">--}}
		...
		<!-- Page Title
		============================================= -->
<section id="page-title" class="page-title-parallax page-title-dark" style="background-image: url('{{asset('assets/demos/ecommerce/images/types/20.jpg')}}'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
...
<div class="container">
	...
	<div class="card p-4 shadow" style="top: -60px;">
		<form action="{{route('shopByFiltering')}}" method="post" class="nobottommargin">
			@csrf
			<div class="row clearfix">
				...
				<div class="col-md-6 col-sm-6 col-12 mt-4 mt-md-0">
					...
					<select class="selectpicker form-control customjs" name="category_id" id="">
				...
				{{--<div class="col-md-4 col-sm-6 col-12 mt-4 mt-md-0">--}}
						...
						{{--<select class="selectpicker customjs form-control" name="name" id="">--}}
                      ...
                      @foreach($products as $pro)
						<div class="product clearfix">
							<div class="product-image">
								<a href="#"><img src="{{asset("images/$pro->image_path")}}" alt="Checked Short Dress"></a>
								<a href="#"><img src="{{asset("images/$pro->image_path")}}" alt="Checked Short Dress"></a>
								{{--<div class="sale-flash">50% Off*</div>--}}
								<div class="product-overlay">
									{{--<a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i>--}}
										{{--<span></span></a>--}}
									<a href="{{route('products.show',$pro->id)}}" class="" data-lightbox=""><i class="icon-zoom-in2"></i><span> Quick View</span></a>
								</div>
							</div>
							<div class="product-desc">
								<div class="product-title"><h3><a href="#">{{$pro->name}}</a></h3></div>
								<div class="product-price"> <ins>${{$pro->price}}</ins></div>
