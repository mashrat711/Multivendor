...
<head>
    ...
    <!-- DatePicker CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/components/datepicker.css')}}" type="text/css" />

    <!-- Bootstrap File Upload CSS -->
    <link rel="stylesheet" href="{{asset('assets/css/components/bs-filestyle.css')}}" type="text/css" />
